...
export function BrandThemeApplier() {
  useEffect(() => {
    ...
    for (const key of [
      "--brand", "--brand-foreground", "--primary", "--primary-foreground",
      "--primary-light", "--primary-muted", "--ring", "--sidebar-primary",
      "--sidebar-primary-foreground", "--sidebar-ring", "--chart-1", "--chart-2",
