...
import { LayoutDashboard, FileText, ClipboardList, FileInput, Mail, Asterisk, Menu, X, LogOut, Settings, User, ShieldCheck } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { href: "/applications", label: "Applications", icon: FileInput },
