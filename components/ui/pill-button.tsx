...
const variantConfig: Record<PillButtonVariant, VariantConfig> = {
  primary: {
    classes: "relative overflow-hidden bg-brand text-brand-foreground [color:var(--brand-foreground)] hover:[color:var(--brand-foreground)] before:absolute before:inset-0 before:rounded-[inherit] before:bg-brand-foreground before:opacity-0 before:transition-opacity before:duration-150 hover:before:opacity-[0.16] active:before:opacity-[0.24] [&>*]:relative",
    tap: { scale: 0.98 },
  },
  secondary: {
