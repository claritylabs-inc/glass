...
export async function GET() {
  ...
  return new ImageResponse(
    (
      ...
      >
        <span style={{ fontSize: "10px", color: "#9ca3af", fontFamily: "sans-serif" }}>
          from
        </span>
        <div style={{ display: "flex", alignItems: "center", gap: "3px", marginTop: "2px" }}>
          <span style={{ fontSize: "15px", color: "#6b7280", fontFamily: "Instrument Serif" }}>
            clarity
          </span>
          <svg width="14" height="14" viewBox="0 0 65 65" fill="none">
            <circle cx="32.5" cy="32.5" r="31" fill="none" stroke="#A0D2FA" strokeWidth="1.25" />
