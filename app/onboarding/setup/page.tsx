        ...
        {currentStep === 2 && (
          <div className="space-y-8">
            ...
            <div className="space-y-3">
              ...
              {policies === undefined ? (
                <div className="rounded-lg border border-foreground/6 bg-card px-4 py-6 text-label-sm text-muted-foreground">
                  Loading…
                </div>
              ) : policyCount === 0 ? (
                <div className="rounded-lg border border-dashed border-foreground/10 bg-card px-4 py-6 text-label-sm text-muted-foreground">
                  No policies yet. Your broker may upload these on your behalf, or you can add
                  them below.
                </div>
              ) : (
                  ...
                  {policies.map((p) => (
                    ...
                    >
                      <div className="min-w-0">
                        ...
                        {p.policyNumber ? (
                          <div className="text-label-sm text-muted-foreground truncate">
                            {p.policyNumber}
                          </div>
                        ) : null}
                      </div>
                      {p.pipelineStatus && p.pipelineStatus !== "ready" ? (
                        <span className="text-label-sm text-muted-foreground/70 ml-3 shrink-0">
                          Processing…
                        </span>
                      ) : null}
                    </div>
