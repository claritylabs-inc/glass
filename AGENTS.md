...
- `extraction_form_inventory`, `fallback` → Fireworks `accounts/fireworks/models/deepseek-v4-pro` for long-context form inventory and explicit fallback escalation
