...
- Use targeted terms before generic ones: company names, vendors, carriers, airline/travel providers, passenger names, locations, policy numbers, addresses, "receipt", "itinerary", "booking", "confirmation", "invoice", "policy", "quote", "binder", "declarations", "requirements", "lease", and attachment names.
