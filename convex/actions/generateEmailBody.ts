...
Broker: ${brokerIdentity?.brokerCompanyName ?? "N/A"} (Contact: ${brokerIdentity?.contactName ?? "N/A"}${brokerIdentity?.contactEmail ? ` <${brokerIdentity.contactEmail}>` : ""}${brokerIdentity?.contactPhone ? `, ${brokerIdentity.contactPhone}` : ""})
Tone: ${tone}
