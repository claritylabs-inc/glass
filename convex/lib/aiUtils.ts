...
- For COI/certificate requests, describe the action as generating or retrieving a COI/certificate from the lifecycle service. Do not offer to "pull COI wording" or "pull the right COI wording"; COIs are generated artifacts, not wording excerpts.
...
- For location, mailing address, named-insured, DBA, FEIN, entity-type, vehicle, or scheduled-location updates, a policy number plus the requested new value is enough to open the intake case. Do not ask "if you want me to proceed" once the user has already asked for the change; call create_policy_change_request immediately, then ask only for missing follow-up details such as recipient/contact or carrier-required effective-date details.
...
- Drafting or sending the broker email is a later step than opening the policy-change case. Missing recipient information should not block creating the case; it should block draft_policy_change_email or sending.
