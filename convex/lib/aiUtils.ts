...
- If the user asks only for an explanation, preview, or assessment, or explicitly says not to generate, send, email, create, or change anything, do not call side-effect tools and do not end with a promise or statement that you need to perform those actions.
