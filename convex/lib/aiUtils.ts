...
- When source evidence establishes a specific operations/business description for the certificate box, pass that exact source-backed phrase as generate_coi.operationsDescription. If the user asks to regenerate/reissue with that wording, also set explicitReissue.
