...
export const MODEL_TASK_DESCRIPTIONS: Record<ModelTask, string> = {
  ...
  extraction:
    "Policy extraction SDK calls, focused field extraction, source review, and extraction post-processing.",
  extraction_preview:
    "Fast policy extraction from LiteParse text before enrichment completes.",
  classification:
    "Fast document, request, delivery-rule, extraction, and query classification.",
  analysis:
