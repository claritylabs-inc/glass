...
describe("procurement intake extraction", () => {
      ...
      insuranceObligations: [
        {
          ...
          scope: null,
          title: " CGL ",
          requirementText: " $1M each occurrence ",
          lineOfBusiness: "cgl",
          limits: [{ kind: "each_occurrence", amount: 1_000_000, label: null }],
          maxDeductible: null,
          coverageForm: "occurrence",
          retroactiveDateOnOrBefore: null,
          provisions: ["additional_insured", "additional_insured"],
          requiredForms: null,
          minAmBestRating: null,
          minAmBestFinancialSize: null,
          admittedRequired: null,
          conditionType: null,
          noticeDays: null,
          sourceExcerpt: "CGL $1M each occurrence",
        },
      ],
      placementSpecifications: [
        {
          key: " Building Square Feet ",
          label: " Square feet ",
          value: " 18,000 ",
  ...
  it("uses the dedicated requirement extraction route", () => {
    expect(modelTaskForCall("requirement_extraction")).toBe(
