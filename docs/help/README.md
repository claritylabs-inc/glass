...
side-by-side guide to every surface. Use the individual guides when you need
setup steps or troubleshooting:

- [Web chat](client-engagement/web-chat.md)
- [Agent email](client-engagement/agent-email.md)
